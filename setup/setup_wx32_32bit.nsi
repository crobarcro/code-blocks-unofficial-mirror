...
#   C:\[PATH_TO_NSIS]\makensis.exe setup_wx32_32bit.nsi             #
...
!define VERSION          23.06
!define VERSION_STR      "2306"
...
!define WX_BASE          D:\Devel\CodeBlocks31\Releases\CodeBlocks_${VERSION_STR}_32
!define WX_VER           32
!define WX_DLL           wxmsw${WX_VER}u_gcc_cb.dll
!define WX_GL_DLL        wxmsw${WX_VER}u_gl_gcc_cb.dll
# Possibly required to adjust manually:
# (CodeBlocks binary folder - the one where codeblocks.exe is.)
!define CB_BASE          D:\Devel\CodeBlocks31\Releases\CodeBlocks_${VERSION_STR}_32
...
!define CB_LOCALE        ${CB_SHARE_CB}\locale
...
!define MINGW_BASE       D:\Devel\CodeBlocks31\Releases\CodeBlocks_${VERSION_STR}_32\MinGW
# Possibly required to adjust manually:
# (Folder with logos and GPL license as text file.)
!define CB_ADDONS        D:\Devel\CodeBlocks31\Releases\Setup
# Possibly required to adjust manually:
# (Folder with PO translation files for locale provided via launchpad.)
!define CB_PO            D:\Devel\CodeBlocks31\src\po
# Possibly required to adjust manually:
# (Folder with documentation provided by mariocup/gd_on.)
!define CB_DOCS_SRC      D:\Devel\CodeBlocks31\Releases\Docs\current\htmlweb
!define CB_DOCS_INI      D:\Devel\CodeBlocks31\Releases\Setup
!ifdef MINGW_BUNDLE
...
!define CB_SPLASH        ${CB_ADDONS}\setup_splash_${VERSION_STR}.bmp
!define CB_LOGO          ${CB_ADDONS}\setup_logo_${VERSION_STR}.bmp
# Possibly required to adjust manually:
...
!endif
        ...
        SetOutPath $INSTDIR${CB_LOCALE}
        SetOutPath $INSTDIR${CB_LOCALE}\de_DE
        File ${CB_PO}\de_DE\*.mo
        SetOutPath $INSTDIR${CB_LOCALE}\es_ES
        File ${CB_PO}\es_ES\*.mo
        SetOutPath $INSTDIR${CB_LOCALE}\fr
        File ${CB_PO}\fr\*.mo
        SetOutPath $INSTDIR${CB_LOCALE}\ru_RU
        File ${CB_PO}\ru_RU\*.mo
        SetOutPath $INSTDIR${CB_LOCALE}\zh_CN
        File ${CB_PO}\zh_CN\*.mo
        SetOutPath $INSTDIR${CB_DOCS}
        File ${CB_DOCS_SRC}\manual_codeblocks_en.chm
        File ${CB_DOCS_SRC}\manual_codeblocks_en.pdf
        File ${CB_DOCS_SRC}\manual_codeblocks_fr.chm
        File ${CB_DOCS_SRC}\manual_codeblocks_fr.pdf
        File ${CB_DOCS_INI}\index.ini
...
!endif
    ...
    SectionGroup "Lexers" SECGRP_LEXERS
        ...
        SectionGroup "Others"
            ...
            Section "PO (translation) file"
                SectionIn 1 4
                SetOutPath $INSTDIR${CB_LEXERS}
                SetOverwrite on
                File ${CB_BASE}${CB_LEXERS}\lexer_po.sample
                File ${CB_BASE}${CB_LEXERS}\lexer_po.xml
                WriteRegStr HKCU "${REGKEY}\Components" "Po (translation) file" 1
            SectionEnd
...
SectionGroup "Contrib Plugins" SECGRP_CONTRIB_PLUGINS
    ...
    Section "CLANGD client plugin" SEC_CLANGD
        SectionIn 1
        SetOutPath $INSTDIR${CB_SHARE_CB}
        SetOverwrite on
    ...
    Section "HeaderGuard plugin" SEC_HEADERGUARD
        SectionIn 1
        SetOutPath $INSTDIR${CB_SHARE_CB}
        SetOverwrite on
        ...
        WriteRegStr HKCU "${REGKEY}\Components" "HeaderGuard plugin" 1
    SectionEnd
...
Section "-un.CLANGD client plugin" UNSEC_CLANGD
...
Section /o "-un.HeaderGuard plugin" UNSEC_HEADERGUARD
...
Section "-un.PO (translation) file" UNSEC_PO
    Delete /REBOOTOK $INSTDIR${CB_LEXERS}\lexer_po.xml
    Delete /REBOOTOK $INSTDIR${CB_LEXERS}\lexer_po.sample
    DeleteRegValue HKCU "${REGKEY}\Components" "PO (translation) file"
SectionEnd
...
Section "-un.Core Files (required)" UNSEC_CORE
    ...
    Delete /REBOOTOK $INSTDIR${CB_PO}\de_DE\*.mo
    RMDir            $INSTDIR${CB_PO}\de_DE
    Delete /REBOOTOK $INSTDIR${CB_PO}\es_ES\*.mo
    RMDir            $INSTDIR${CB_PO}\es_ES
    Delete /REBOOTOK $INSTDIR${CB_PO}\fr\*.mo
    RMDir            $INSTDIR${CB_PO}\fr
    Delete /REBOOTOK $INSTDIR${CB_PO}\ru_RU\*.mo
    RMDir            $INSTDIR${CB_PO}\ru_RU
    Delete /REBOOTOK $INSTDIR${CB_PO}\zh_CN\*.mo
    RMDir            $INSTDIR${CB_PO}\zh_CN
    RMDir            $INSTDIR${CB_PO}
...
!endif
    ...
    Delete /REBOOTOK $INSTDIR\${WX_DLL}
    Delete /REBOOTOK $INSTDIR\${WX_GL_DLL}
...
!endif
    ...
    !insertmacro SELECT_UNSECTION "PO (translation) file"              ${UNSEC_PO}
    ...
    !insertmacro SELECT_UNSECTION "CLANGD client plugin"               ${UNSEC_CLANGD}
    ...
    !insertmacro SELECT_UNSECTION "HeaderGuard plugin"                 ${UNSEC_HEADERGUARD}
...
!insertmacro MUI_DESCRIPTION_TEXT ${SEC_CLANGD}              "An alternative code completion plugin based on CLANGD"
...
!insertmacro MUI_DESCRIPTION_TEXT ${SEC_HEADERGUARD}         "Automatically adds include guards to C/C++ header files."
