...
Les textes de plusieurs paragraphes (par exemple \pxref{sec:variables_types} ou \pxref{sec:plugins}) sont les documentations officielles du site Wiki de \codeblocks (éventuellement revues et complétées) où elles ne sont disponibles qu'en anglais.
