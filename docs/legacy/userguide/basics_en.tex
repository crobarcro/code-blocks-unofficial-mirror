...
The instructions in several paragraphs (for example \pxref{sec:variables_types} or \pxref{sec:plugins}) are official documentations of the \codeblocks Wiki site (eventually reviewed and amended) and available in english only.
